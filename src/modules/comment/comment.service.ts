...
import { CommentCreateDto, CommentUpdateDto } from 'src/dtos/comment.dto';
...
export class CommentService {
  ...
  constructor(
    @InjectModel('comment') private categoryMongo: Model<CommentModel>
  ) { }
  ...
  async create(body: CommentCreateDto): Promise<CommentModel> {
  ...
  async update(id: string, body: CommentUpdateDto): Promise<CommentModel> {
  ...
  async delete(id: string): Promise<CommentModel> {
